...
export default function PortfolioPage() {
  ...
  const categories = [
    { id: "all", label: "All Projects", count: 6, icon: LayoutGrid },
    { id: "web", label: "Web Design", count: 3, icon: Globe },
    { id: "uiux", label: "UI/UX Design", count: 1, icon: Layout },
    { id: "branding", label: "Branding", count: 1, icon: Palette },
    { id: "social", label: "Social Media", count: 1, icon: Share2 },
    { id: "logo", label: "Logo", count: 1, icon: Award }
  ];
  ...
  return (
    <main className="flex-1 w-full bg-white dark:bg-[#080710] text-brand-dark dark:text-white transition-colors duration-300 relative overflow-x-clip font-sans pb-6">
      ...
      {/* Cursive Font Imports for About Page CTA style matching */}
      ...
      <section className="-mt-[110px] sm:-mt-[125px] lg:-mt-[140px] pt-[130px] sm:pt-[145px] lg:pt-[160px] pb-10 md:pb-14 relative overflow-hidden min-h-[580px] sm:min-h-[640px] lg:min-h-[700px] flex items-center border-b border-brand-zinc-200 dark:border-white/10">
        ...
        <div className="absolute inset-0 w-full h-full pointer-events-none z-0 overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-white via-white/75 to-transparent dark:from-[#080710] dark:via-[#080710]/75 dark:to-transparent pointer-events-none" />
        </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-12 relative z-10 py-6 md:py-8 w-full">
          ...
          >
            ...
            <p className="text-sm sm:text-base font-sans text-brand-zinc-600 dark:text-zinc-300 font-normal leading-relaxed max-w-lg">
              Explore our latest projects — beautifully designed, strategically built, and focused on growing brands online.
            </p>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-12 relative z-10 pt-8 pb-4">
          ...
          <div className="bg-white/90 dark:bg-[#12121e]/90 backdrop-blur-2xl border border-brand-zinc-200/90 dark:border-white/10 shadow-[0_10px_35px_rgba(3,6,172,0.08)] dark:shadow-[0_10px_35px_rgba(0,0,0,0.4)] p-2 rounded-full flex items-center justify-start sm:justify-center gap-1.5 sm:gap-2.5 overflow-x-auto scrollbar-none max-w-fit mx-auto px-3 sm:px-4">
            {categories.map((cat) => {
              ...
              return (
                ...
                >
                  {/* Animated Gradient Background Pill */}
                  {isActive && (
                    <motion.div
        ...
        {/* ── 3. PORTFOLIO GRID (BUTTERY SMOOTH FILTER TRANSITION) ─────── */}
                ...
                >
                  ...
                  <div className="flex items-center gap-1.5 flex-wrap pt-4 border-t border-brand-zinc-200/80 dark:border-white/10">
                    {project.tech.map((t, idx) => (
                      <span key={idx} className="text-[9.5px] font-mono font-bold text-brand-zinc-600 dark:text-zinc-300 bg-brand-zinc-100 dark:bg-zinc-800/90 border border-brand-zinc-200/60 dark:border-white/10 px-2.5 py-1 rounded-md">
                        {t}
                      </span>
                    ))}
                  </div>
        ...
        {/* ── 4. OUR CREATIVE PROCESS SECTION (CLEAN 4-STEP GRID) ── */}
        <section className="my-16">
          <div className="bg-white dark:bg-[#12121e] border border-brand-zinc-200/90 dark:border-white/10 rounded-[32px] p-8 sm:p-14 text-center relative overflow-hidden shadow-sm">
            ...
            <h2 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-black text-brand-dark dark:text-white mb-3 relative z-10">
              From Concept to <span className="text-brand-blue dark:text-brand-yellow font-cursive font-normal text-4xl sm:text-5xl lg:text-6xl pl-1">Impact</span>
            </h2>
            ...
            <p className="font-sans text-sm sm:text-base text-brand-zinc-600 dark:text-zinc-300 max-w-xl mx-auto mb-12 leading-relaxed relative z-10">
              A proven 4-step framework engineered for maximum conversion and brand authority.
            </p>
        ...
        {/* ── 5. BOTTOM CTA BANNER (CLEAN SHADOW & PERFECT SPACING) ── */}
          ...
          <div className="cta-banner-card !shadow-[0_16px_40px_-12px_rgba(3,6,172,0.22)] dark:!shadow-[0_16px_40px_-12px_rgba(0,0,0,0.5)]">
            <div className="relative z-10 flex flex-col justify-center gap-6 p-8 sm:p-12 lg:p-14 lg:max-w-[58%]">
              ...
              <h2 className="font-heading text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black leading-[1.18] tracking-tight text-white">
                ...
                <span className="whitespace-nowrap inline-block">
                  ...
                  <span className="relative inline-block">
                    <span className="font-cursive text-[#E9BD36] text-3xl sm:text-4xl lg:text-5xl font-normal pl-1">Today?</span>
              ...
              <p className="text-sm sm:text-base font-sans text-white/90 font-normal leading-relaxed max-w-lg">
                Let's turn your vision into a stunning digital reality. Get in touch for a custom strategy, competitive pricing, and fast execution.
              </p>
